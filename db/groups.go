...
func GetGroupByID(d *sql.DB, groupID int) (*models.Group, error) {
	return retry("GetGroupByID", func() (*models.Group, error) {
		var group models.Group
...
func GetUserGroups(d *sql.DB, userID int) ([]models.Group, error) {
	return retry("GetUserGroups", func() ([]models.Group, error) {
		rows, err := d.Query(
...
func IsGroupMember(d *sql.DB, groupID, userID int) (bool, error) {
	return retry("IsGroupMember", func() (bool, error) {
		var exists bool
		err := d.QueryRow(
